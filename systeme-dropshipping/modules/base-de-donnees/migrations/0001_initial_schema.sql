-- =============================================================================
-- MIGRATION 0001 — Schéma initial du système dropshipping
-- =============================================================================
-- Ce fichier est la première migration versionnée appliquée à Supabase.
-- Il est strictement équivalent à `modules/base-de-donnees/schema.sql`
-- (version canonique tenue à jour pour les diff lisibles + génération de types).
--
-- Application :
--   • Manuel  : copier-coller dans Supabase Dashboard > SQL Editor.
--   • Auto    : `pnpm run db:setup` (postgres-js, requiert DATABASE_URL).
--   • CLI     : `supabase db push` après init du projet local.
-- =============================================================================
